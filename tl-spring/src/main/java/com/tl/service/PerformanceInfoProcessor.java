...
public class PerformanceInfoProcessor {
	...
	private void setPerformanceList(PerformanceRequestDto prd) {
		String API_URL = String.format( // apiKey, prd 사용해서 api url 생성
				...
				apiKey, prd.startdate, prd.enddate, prd.cpage, prd.rows, prd.shprfnm, prd.shprfnmfct, prd.shcate,
				prd.prfplccd, prd.signgucode, prd.signgucodesub, prd.kidstate, prd.prfstate, prd.openrun,
				prd.afterdate);
